...
Just Add <b>ᴄ</b> In The Starting Of The Commands 𝖳o 𝖴𝗌e Then 𝖥𝗈r Channel .
...
/skip : Skip The Current Playing Stream And Start Stream The Next Track In Queue .

/end Or /stop : Clears The Queue And End The Current Playing Stream .

/player : Get A Interacvtice Player Panel .
...
/auth [ User Id / Username ] : Add A User To Auth List Of The Bot .
/unauth [ User id / Username ] : Removed A Auth Users From The Auth Users List .
